...
// Fragment shader source code for the autonomous smokey background effect
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Autonomous distortion loop (7 iterations, driven purely by time)
...
/**
 * A React component that renders an autonomous WebGL shader background.
 */
export function SmokeyBackground({
  backdropBlurAmount = "sm",
  color = "#3B0A57", // Default deep purple (#3B0A57)
  className = "",
  ...
  return (
    <div className="w-full max-w-sm p-8 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl">
      ...
      <form className="space-y-8">
        ...
        <button
          type="submit"
          className="group w-full flex items-center justify-center py-3 px-4 bg-purple-600 hover:bg-purple-700 rounded-lg text-white font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-purple-500 transition-all duration-300 shadow-lg shadow-purple-900/40"
        >
          Sign In
        ...
        <button
          type="button"
          className="w-full flex items-center justify-center py-2.5 px-4 bg-white/90 hover:bg-white rounded-lg text-gray-700 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-purple-500 transition-all duration-300"
        >
